    ...
    <div class="col-md-7" style="float: none; margin: 0 auto;">
      <div class="form-area">
        ...
        <br style="clear: both">
          ...
          <div class="col-sm-9">
                  <input type="date" class="form-control" placeholder="Rent Start Date" name="rent_start_date" value="<?php echo $rent_start_date; ?>" readonly><br>
                </div>
                <div class="col-sm-3" style="padding-down: 5px;">
                Rent End Date:
                </div>
       ...
       <button type="submit" style="margin:5px;" id="submit" name="submit" class="btn btn-warning pull-right"> UPDATE</button> 
          <a style="margin:5px;" class="btn btn-primary pull-right" href="mybookings.php" role="button">Back</a>    
        </form>
