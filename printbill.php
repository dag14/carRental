...
$id = $_GET["id"];
$distance = NULL;
$days = $conn->real_escape_string($_POST['no_of_days']);
$fare = $conn->real_escape_string($_POST['hid_fare']);
$total_amount = $days * $fare;
$car_return_date = date('Y-m-d');
$return_status = "R";
$login_customer = $_SESSION['CUSTOMER_NAME'];

$sql0 = "SELECT rc.id, rc.rent_end_date, rc.full_name, rc.rent_start_date, c.car_name, c.car_nameplate,rc.confirmation FROM rentedcars rc ,cars c WHERE id = '$id' AND c.car_id = rc.car_id";
...
if ($result1){
     ...
     WHERE rc.car_id=c.car_id AND rc.driver_id=d.driver_id AND rc.username = '$login_customer' AND rc.id = '$id'";
    ...
    <div class="container">
        ...
        <div class="box">
            ...
            <div class="col-md-10" style="float: none; margin: 0 auto; ">
                ...
                <br>
                <h4> <strong>Fare:&nbsp;</strong>  Birr<?php echo $fare ?></h4>
                <br>
                ...
                ?>
                <h4> <strong>Total Fine:</strong> <label class="text-danger"> Birr<?php echo $total_fine; ?>/- </label> for <?php echo $extra_days;?> extra days.</h4>
                <br>
                <?php } ?>
                <h4> <strong>Total Amount: </strong> Birr<?php echo $total_amount; ?>     </h4>
                <br>
            </div>
            <div class="text-right"><br>
               <a class="btn btn-primary btn-lg" href="mybookings.php" role="button">Back</a>
</div> 
        </div>
