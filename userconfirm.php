...
<?php
    ...
    $sql1 = "INSERT into users(ID,USERNAME,PASSWORD,TYPE_ID) 
     
    VALUES('" . $EMPLOYEE_ID . "','" . $USERNAME . "',sha1('{$PASSWORD}'),'2')";
    $result1 = $conn->query($sql1);

    $sql2 = "UPDATE employee SET account = 'yes' WHERE EMPLOYEE_ID = '$EMPLOYEE_ID'";
