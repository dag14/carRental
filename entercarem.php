...
<body>
    ...
    <div class="col-md-7" style="float: none; margin: 0 auto;">
      <div class="form-area">
        <form role="form" action="entercarem1.php" enctype="multipart/form-data" method="POST">
        <br style="clear: both">
          ...
          <div class="form-group">
            ...
            <div class="form-group">
            <input type="text" class="form-control" id="engine_cc" name="engine_cc" onkeypress="return (event.charCode == 46 || event.charCode !=8 && event.charCode ==0 || (event.charCode >= 48 && event.charCode <= 57))" placeholder="Engine CC" required>
            </div>   
      ...
      <?php
            ...
            echo '<td > <div class="btn-group">
                            ...
                            <ul class="dropdown-menu text-center" role="menu">
                                <li>
                                  <a type="button" class="btn btn-warning bg-gradient-warning btn-block" style="border-radius: 0px;" href="car_editem.php?action=edit & id='.$row['car_id']. '">
                                    <i class="fas fa-fw fa-edit"></i> Edit
                                  </a>
                                </li>
                                <li>
                                  <a type="button" class="btn btn-danger bg-gradient-danger btn-block" style="border-radius: 0px;" href="car_delem.php?action=delete & id='.$row['car_id']. '">
                                    <i class="fa fa-trash"></i> Delete
                                  </a>
                                </li>
                            </ul>
                            </div><a type="button" class="btn btn-success pull-right" href="cardt2.php?action=edit & id='.$row['car_id'] . '"><i ></i> Detail</a>  
                          </div> </td>';
