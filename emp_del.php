...
<div class="container" style="margin-top: 65px;" >
    <div class="col-md-7" style="float: none; margin: 0 auto;">
      <div class="form-area">
        ...
        $sql1 = "DELETE FROM employee WHERE EMPLOYEE_ID = $emp_id";
        $result4 = $conn->query($sql1);        
        				
            ?>
    			<script type="text/javascript">alert("Employee Successfully Deleted.");window.location = "employeesignup.php";</script>					
