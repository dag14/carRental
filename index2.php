    ...
    <nav class="navbar navbar-custom navbar-fixed-top" role="navigation" style="color: black">
        <div class="container">
            <div class="navbar-header">
                ...
                <a nav class="navbar navbar-expand navbar-light bg-white topbar mb-4 static-top shadow" style="text-decoration: none; font-size: 22px;" href="index2.php">
            ...
            if(mysqli_num_rows($result1) > 0) {
                while($row1 = mysqli_fetch_assoc($result1)){
                   ...
                   // $car_type = $row1["car_type"];
                    ...
                    ?>
            <a href="booking2.php?id=<?php echo($car_id) ?>">
            <div class="sub-menu">
