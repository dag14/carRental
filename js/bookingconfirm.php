...
<?php
    ...
    if (mysqli_num_rows($result0) > 0) {
        while($row0 = mysqli_fetch_assoc($result0)) {
            ...
            if($type == "wd" ){
                ...
                $fare = $row0["wd_price_per_day"];
            } else if ($type == "wod" ){
                $fare = $row0["car_type"];
            } else if ($type == "wod" ){
                $fare = $row0["wod_price_per_day"];
            } else {
                $fare = "NA";
            }
        }
    ...
    if($err_date >= 0) { 
    $sql1 = "INSERT into rentedcars(USERNAME,car_id,driver_id,booking_date,rent_start_date,rent_end_date,fare,return_status) 
    VALUES('" . $USERNAME . "','" . $car_id . "','" . $driver_id . "','" . date("Y-m-d") ."','" . $rent_start_date ."','" . $rent_end_date . "','" . $fare . "','" . $return_status . "')";
    ...
    $sql4 = "SELECT * FROM  cars c, employee e, driver d, rentedcars rc WHERE c.car_id = '$car_id' AND d.driver_id = '$driver_id'  e.FIRST_NAME = d.USERNAME";
    ...
    <div class="container">
        ...
        <div class="box">
            ...
            <div class="col-md-10" style="float: none; margin: 0 auto; ">
                ...
                <br>
                <h4> <strong>FIRST NAME:</strong>  <?php echo $FIRST_NAME; ?></h4>
                <br>
                <h4> <strong>PHONE NUMBER: </strong> <?php echo $PHONE_NUMBER; ?></h4>
                <br>
            </div>
        </div>
