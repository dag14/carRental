    ...
    <div  style="margin-top: 65px;" >
      ...
      <div class="form-area">
        ...
        <br style="clear: both">
          ...
          <div class="form-group">
            <input type="text" class="form-control" id="driver_phone" onkeypress="return (event.charCode !=8 && event.charCode ==0 || (event.charCode >= 48 && event.charCode <= 57))" name="driver_phone" placeholder="Phone" required>
          </div>
          <div class="form-group">
          Date Of Birth
      ...
      <?php
            ...
            echo '<td > <div class="btn-group">
                            ...
                            <ul class="dropdown-menu text-center" role="menu">
                                <li>
                                  <a type="button" class="btn btn-warning bg-gradient-warning btn-sm" style="border-radius: 0px;" href="drv_edit.php?action=edit & id='.$row['driver_id']. '">
                                    <i class="fas fa-fw fa-edit"></i> Edit
                                  </a>
                                </li>
                                <li>
                                  <a type="button" class="btn btn-danger bg-gradient-danger btn-sm" style="border-radius: 0px;" href="drv_del.php?action=delete & id='.$row['driver_id']. '">
                                    <i class="fa fa-trash"></i> Delete
                                  </a>
                                </li>
                            </ul>
                            </div><a type="button" class="btn btn-success pull-right" href="driverdt.php?action=edit & id='.$row['driver_id'] . '"><i ></i> Detail</a>  
                          </div> </td>';
