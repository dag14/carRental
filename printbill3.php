...
$return_status = "R";
//$login_customer = $_SESSION['FIRST_NAME'];

$sql0 = "SELECT rc.id, rc.rent_end_date, rc.full_name, rc.rent_start_date, c.car_name, c.car_nameplate FROM rentedcars rc, cars c WHERE id = '$id' AND c.car_id = rc.car_id";
...
?>
    ...
    <div class="container">
        ...
        <div class="box">
            ...
            <a class="btn btn-primary btn-lg" href="prereturncar3.php" role="button">Back</a>
            </div>
        </div>
