 ...
 <nav class="navbar navbar-custom navbar-fixed-top" role="navigation" style="color: black">
   ...
   if (mysqli_num_rows($result4) > 0) {
    ...
    <div class="container" style="margin-top: 80px;" >
      ...
      <div class="form-area">
        <form role="form" action="car_edit1.php" method="POST">
        <br style="clear: both">
          ...
          <div class="col-sm-9">
            ...
            <div class="col-sm-3" style="padding-top: 5px;">
                ...
                <div class="col-sm-9">
            <input class="form-control"  name="engine_cc" onkeypress="return (event.charCode == 46 || event.charCode !=8 && event.charCode ==0 || (event.charCode >= 48 && event.charCode <= 57))" placeholder="Engine CC" value="<?php echo $engine_cc; ?>" required autofocus=""><br>
            </div>   
            <div class="col-sm-3" style="padding-top: 5px;">
            Fuel Type:
                </div>
          ...
          <button type="submit" style="margin:5px;" id="submit" name="submit" class="btn btn-warning pull-right"> UPDATE</button>   
           <a style="margin:5px;" class="btn btn-primary pull-right" href="entercar.php" role="button">Back</a>
