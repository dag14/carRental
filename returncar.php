...
function dateDiff($start, $end) {
 ...
 $id = $_GET["id"];
 $sql1 = "SELECT c.car_name, c.car_nameplate, rc.confirmation, rc.rent_start_date, rc.rent_end_date, rc.fare,  d.driver_name, d.driver_phone
 ...
 if (mysqli_num_rows($result1) > 0) {
    ...
    <script type="text/javascript">
			alert("Please visit our office to cancel the reservation and get refund!");
      ...
      <div class="form-area">
        ...
        <br style="clear: both">
          ...
          <h6 style="margin-bottom: 25px; text-align: center; font-size: 12px;"> Allow your driver to fill the below form </h6>
           ...
           <h5> Number of Days:&nbsp;  <?php echo($no_of_days);?></h5>

           <h5> Fare:&nbsp;  Birr <?php echo($fare);?></h5> 
